---
agent: agent
description: This prompt is used to analyze and fix a pending ticket by enhancing the user story with technical details and best practices.
---

Please analyze and fix the ticket: $ARGUMENTS.

Follow these steps:

1. Get the ticket from tickets/pending folder
...
5. If the user story lacks the technical and specific detail necessary to allow the developer to be fully autonomous when completing it, provide an improved story that is clearer, more specific, and more concise in line with product best practices described in step 4. Use the technical context you will find in docs folder. Return it in markdown format.
6. Create a new ticket in the tickets/refined folder. Use the same name of the ticket file for the new file. The file will have the new content after the old one and marking each section with the h2 tags [original] and [enhanced]. Apply proper formatting to make it readable and visually clear, using appropriate text types (lists, code snippets...).