...
- Log the user or operator prompt only, not the model response.
- Use one line per entry: `N. "prompt text"`

Before finishing, confirm the latest meaningful prompts from the current task were appended once and in order.
