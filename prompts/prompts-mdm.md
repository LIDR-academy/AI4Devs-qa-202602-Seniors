...
| 5 | "Anade selectores `data-testid` estables en la vista `PositionDetails`, en cada `StageColumn` y en cada `CandidateCard`." | Hacer la interfaz automatizable sin depender de texto visible frágil o clases CSS. |
